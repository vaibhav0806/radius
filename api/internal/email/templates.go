...
func NegativeReviewEmail(businessName, authorName, reviewText string, rating int, dashboardURL string) (subject, body string) {
	...
	`, rating, html.EscapeString(businessName), html.EscapeString(authorName), html.EscapeString(reviewText), html.EscapeString(dashboardURL))
	return
}
